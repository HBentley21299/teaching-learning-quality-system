...
$scripts = @(
    ...
    (Join-Path -Path $root -ChildPath "database\migrations\014_quality_ui_data_linking.sql"),
    (Join-Path -Path $root -ChildPath "database\migrations\015_exact_environment_rubrics.sql"),
